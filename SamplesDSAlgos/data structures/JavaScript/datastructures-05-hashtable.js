...
console.log(`keys = ${hashTable1.getKeys()}`);
...
console.log(`Searching for carrot 3 = ${hashTable.search("Carrot")}`);
console.log(`keys = ${hashTable.getKeys()}`);
